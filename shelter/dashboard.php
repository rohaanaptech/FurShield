...
$products_count = getCount($conn, "SELECT COUNT(*) AS count FROM products"); // no shelter_id
...
<title>FurShield - Shelter Dashboard</title>
...
<div class="top-header">
    <div class="welcome-message">
        <h1>Welcome, <?php echo $_SESSION['name'] ?? 'Shelter'; ?>!</h1>
...
<div class="quick-actions">
    <div class="action-card">
        ...
        <a href="add_pet.php" class="btn btn-primary">Add New</a>
    </div>
    <div class="action-card">
        <div class="action-icon">
    ...
    <div class="action-card">
        ...
        <h3 class="action-title">Adoption Requests</h3>
        <a href="adoption_requests.php" class="btn btn-primary">View All</a>
    </div>
    <div class="action-card">
        <div class="action-icon">
...
<div class="dashboard-section">
    <div class="section-header">
        <h2 class="section-title"><i class="fas fa-heart"></i> Recent Adoption Requests</h2>
        <a href="adoption_requests.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
    </div>
    ...
    <div class="empty-state">
        ...
        <a href="my_pets.php" class="btn btn-primary">View Your Pets</a>
    </div>
    <?php endif; ?>
</div>
...
<div class="dashboard-section">
    <div class="section-header">
        <h2 class="section-title"><i class="fas fa-paw"></i> Recently Added Pets</h2>
        <a href="my_pets.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
    </div>
    ...
    <div class="pets-grid">
        ...
        <div class="pet-card">
            ...
            <div class="pet-info">
                <h3 class="pet-name"><?php echo $pet['pet_name']; ?></h3>
                <div class="pet-details">
                    <?php echo ucfirst($pet['species']); ?> • <?php echo ucfirst($pet['breed']); ?><br>
                    <?php echo $pet['age']; ?> years old
                </div>
                <div class="pet-actions">
                    <a href="edit_pet.php?id=<?php echo $pet['id']; ?>" class="btn btn-secondary"><i class="fas fa-edit"></i> Edit</a>
                    <a href="pet_details.php?id=<?php echo $pet['id']; ?>" class="btn btn-primary"><i class="fas fa-eye"></i> View</a>
                </div>
            </div>
        </div>
        <?php endwhile; ?>

...
if (!empty($_GET['age_range'])) {
    ...
    if ($age_range == "0-1") {
        $sql .= " AND p.age >= 0 AND p.age <= 1";
    } elseif ($age_range == "1-3") {
        $sql .= " AND p.age > 1 AND p.age <= 3";
    } elseif ($age_range == "3-8") {
        $sql .= " AND p.age > 3 AND p.age <= 8";
    } elseif ($age_range == "8+") {
        $sql .= " AND p.age >= 8";
    }
}
...
// Helper function to determine size category based on species
function getSizeCategory($species) {
    $largeSpecies = ['Dog', 'German Shepherd', 'Labrador', 'Golden Retriever'];
    $mediumSpecies = ['Beagle', 'Corgi', 'Bulldog'];
    $smallSpecies = ['Cat', 'Persian', 'Siamese', 'Bird', 'Parrot', 'Rabbit'];
    
    if (in_array($species, $largeSpecies)) return 'Large';
    if (in_array($species, $mediumSpecies)) return 'Medium';
    if (in_array($species, $smallSpecies)) return 'Small';
...
<head>
    ...
    <style>
        ...
        /* Simple header if header.php is missing */
        .simple-header {
            background: var(--cream);
            padding: 15px 0;
            position: fixed;
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <select class="form-select" name="species">
                            ...
                            $species_sql = "SELECT DISTINCT species FROM pets WHERE species IS NOT NULL ORDER BY species";
                    ...
                    <div class="col-md-3 mb-3">
                        <select class="form-select" name="breed">
                            ...
                            $breed_sql = "SELECT DISTINCT breed FROM pets WHERE breed IS NOT NULL ORDER BY breed";
                    ...
                    <div class="col-md-3 mb-3">
                        <select class="form-select" name="age_range">
                            ...
                            <option value="0-1" <?php echo (isset($_GET['age_range']) && $_GET['age_range'] == '0-1') ? 'selected' : ''; ?>>Puppy/Kitten (0-1 yr)</option>
        ...
        <div class="pets-grid">
            <?php if (count($pets) > 0): ?>
                <?php foreach ($pets as $pet): ?>
                    <div class="pet-card">
                        <div class="pet-image">
                            <img src="<?php echo !empty($pet['photo']) ? htmlspecialchars($pet['photo']) : 'https://images.unsplash.com/photo-1554692918-08fa0fdc9db3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'; ?>" alt="<?php echo htmlspecialchars($pet['name']); ?>">
                        </div>
                        <div class="pet-info">
                            ...
                            <div class="pet-details">
                                ...
                                <div class="pet-detail">
                                    <div class="detail-value"><?php echo htmlspecialchars($pet['gender']); ?></div>
                                    <div class="detail-label">Gender</div>
                                </div>
                                <div class="pet-detail">
                                    <div class="detail-value"><?php echo getSizeCategory($pet['species']); ?></div>
                                    <div class="detail-label">Size</div>
                                </div>
                            </div>
                            <p class="pet-description"><?php echo !empty($pet['notes']) ? htmlspecialchars(substr($pet['notes'], 0, 100)) . '...' : 'Loving companion looking for a forever home.'; ?></p>
                            <div class="pet-actions">
                                <button type="button" class="btn btn-outline view-details-btn" data-bs-toggle="modal" data-bs-target="#petModal" data-pet-id="<?php echo $pet['id']; ?>">View Details</button>
                                <a href="adopt.php?pet_id=<?php echo $pet['id']; ?>&type=shelter" 
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <a href="adopt.php?pet_id=<?php echo $row['id']; ?>&type=shelter" class="btn btn-primary">Adopt Me</a>
    ...
    petModal.addEventListener('show.bs.modal', function (event) {
        ...
        fetch('get_pet_details.php?id=' + petId)
                    ...
                    modalBody.innerHTML = `
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <hr>
                                <h5>About</h5>
                                <p>${pet.notes || 'Loving companion looking for a forever home.'}</p>
                                ${pet.owner_name ? `
                                <hr>
                                <h5>Owner Information</h5>
                                <p><strong>Name:</strong> ${pet.owner_name}</p>
                                ${pet.owner_email ? `<p><strong>Email:</strong> ${pet.owner_email}</p>` : ''}
                                ` : ''}
                            </div>
                        </div>
                    `;
            ...
            .catch(error => {
                ...
                modalBody.innerHTML = '<div class="alert alert-danger">Error loading pet details. Please try again later.</div>';
            });
    });
});
</script>
    ...
    <div class="container">
        <div class="footer-content">
            <div class="footer-col">
                ...
                <p class="footer-about">Every Paw Deserves a Shield of Love. Our mission is to provide the best care management platform for pets and their owners.</p>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="pets.php"><i class="fas fa-chevron-right"></i> Pets</a></li>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    <li><a href="#"><i class="fas fa-chevron-right"></i> Pet Profiles</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right"></i> Health Tracking</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right"></i> Appointments</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right"></i> Pet Products</a></li>
                    <li><a href="pets.php"><i class="fas fa-chevron-right"></i> Adoption Portal</a></li>
                </ul>
            </div>
            <div class="footer-col">
                <h3 class="footer-heading">Contact Us</h3>
                <ul class="footer-links">
                    <li><i class="fas fa-map-marker-alt"></i> 123 Pet Care Ave, Pet City</li>
                    <li><i class="fas fa-phone"></i> (555) 123-4567</li>
                    <li><i class="fas fa-envelope"></i> info@furshield.com</li>
                </ul>
            </div>
        </div>
        <div class="copyright">
